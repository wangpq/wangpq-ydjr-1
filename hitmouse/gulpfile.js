...
var tasks={
    ...
    cat : {
		css : {
			...
			group : [
				{
					value : ['reset.css','public.css','gztshare.css','index.css'],
					name : "index"
                },
				{
					value : ['reset.css','public.css','rank.css'],
					name : "rank"
				} 
			]
		},
		js : {
			...
			group : [
				...
				{
					value : ['buzz.js','jquery.js','fastclick.js','audio.js','audios.js','gztshare.js','emile.js','emile.easing.js','public.js','gztUtil.js','mouse.js','snow.js','index.js'],
					name : "index"
                },
				{
					value : ['fastclick.js','jquery.js','public.js','gztUtil.js','rank.js'],
					name : "rank"
                }
			]
		}
...
gulp.task('copyAudio', function(){
    gulp.src(config.audio.path.src+'**/*.{mp3,ogg}')
        .pipe(gulp.dest(config.audio.path.dest))
});

// copySwf
gulp.task('copySwf', function(){
    gulp.src(config.swf.path.src+'**/*.{swf}')
        .pipe(gulp.dest(config.swf.path.dest))
});
...
gulp.task('live', ['gulpHtmlReplace','concatMinCss','concatMinJs','copyImages','copyJsLrc','copyAudio','copySwf']);
