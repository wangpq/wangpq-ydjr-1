    ...
    cat : {
		css : {
			...
			group : [
				...
				{
					value : ['reset.css','public.css','card.css'],
					name : "card"
				}
			]
		},
		js : {
			...
			group : [
				...
				{
					value : ['fastclick.js','reqwest.js','common.js','gztUtil.js','index.js'],
					name : "index"
				},
				{
					value : ['fastclick.js','reqwest.js','common.js','card.js'],
					name : "card"
				}
			]
		}
